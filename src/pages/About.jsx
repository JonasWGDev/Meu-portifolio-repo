    ...
    <div className={style.container}>
      <div className={style.aboutMe}>
        ...
        <p>
          ...
          também já estudei Desenvolvimento de Jogos com <strong>Godot Game Engine </strong> na qual
          ...
          e <strong>Pixel Art </strong> e sou um praticante de <strong>Taekwondo </strong>.
          <br></br><br></br>
          ...
          que na maioria os métodos de programação são por blocos de código pre prontos,
          ...
          ela ate hoje.
          <br></br><br></br>
          Conheci o <strong>Front-end</strong> em um <strong>sábado (04/06/2022)</strong> e me apaixonei por ele desde então escolhi
          ficar nessa área estou estudando cada vez mais para me tornar um profissional.

          Me siga no <strong>linkedin</strong>, <strong>github</strong> e acompanhe meu <strong>portifólio</strong> para ver minhas evoluções na forma
          de projetos que estarei adicionando.

          se quiser entrar em contato comigo para alguma informação, convite, oferta, sugestão ou qualquer outra
          coisa clique no botão abaixo e me mande um email assim que possível estarei respondendo.
        </p>
